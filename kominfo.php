...
$use_auth = true;
$auth_users = array(
    'adm' => '$2y$10$X0ipRmUsOPNfbCfzF1t2XujJzeYwGU5oN4qEd4DNp.LJsBQ7qM.gq', 
);
...
<head>
    ...
    <style>
        body.fm-login-page{ background-color:#fff;;background-repeat: no-repeat;background-position: center center;background-size: cover;}
